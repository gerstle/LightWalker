...
public:
	...
	void setTapThreshold(short tapThreshold);
	short getTapThreshold();
	void setAxisGains(double *_gains);
	void getAxisGains(double *_gains);
	void setAxisOffset(short x, short y, short z);
	void getAxisOffset(short* x, short* y, short*z);
	void setTapDuration(short tapDuration);
	short getTapDuration();
	void setDoubleTapLatency(short doubleTapLatency);
	short getDoubleTapLatency();
	void setDoubleTapWindow(short doubleTapWindow);
	short getDoubleTapWindow();
	void setActivityThreshold(short activityThreshold);
	short getActivityThreshold();
	void setInactivityThreshold(short inactivityThreshold);
	short getInactivityThreshold();
	void setTimeInactivity(short timeInactivity);
	short getTimeInactivity();
	void setFreeFallThreshold(short freeFallthreshold);
	short getFreeFallThreshold();
	void setFreeFallDuration(short freeFallDuration);
	short getFreeFallDuration();
	...
	bool triggered(byte interrupts, short mask);
	...
	void setRangeSetting(short val);
	bool getSelfTestBit();
...
private:
	...
	void readFrom(byte address, short num, byte buff[]);
	void setRegisterBit(byte regAdress, short bitPos, bool state);
	bool getRegisterBit(byte regAdress, short bitPos);  
