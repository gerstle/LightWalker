...
//
//  26 January 2014 Casey Gerstle, inappropirates.com
//      Modified to handle a 32-bit processor
//
/*******************************************************************************/
...
void ADXL345::setRangeSetting(short val) {
	byte _s;
	byte _b;
...
void ADXL345::setTapThreshold(short tapThreshold) {
...
void ADXL345::setAxisOffset(short x, short y, short z) {
...
void ADXL345::getAxisOffset(short* x, short* y, short*z) {
	byte _b;
...
void ADXL345::setTapDuration(short tapDuration) {
...
void ADXL345::setDoubleTapLatency(short doubleTapLatency) {
	byte _b = byte (doubleTapLatency);
	writeTo(ADXL345_LATENT, _b);  
}

// Gets the Latent value
short ADXL345::getDoubleTapLatency() {
	byte _b;
...
void ADXL345::setDoubleTapWindow(short doubleTapWindow) {
...
short ADXL345::getDoubleTapWindow() {
	byte _b;
...
void ADXL345::setActivityThreshold(short activityThreshold) {
...
short ADXL345::getActivityThreshold() {
	byte _b;
...
void ADXL345::setInactivityThreshold(short inactivityThreshold) {
...
short ADXL345::getInactivityThreshold() {
	byte _b;
...
void ADXL345::setTimeInactivity(short timeInactivity) {
...
short ADXL345::getTimeInactivity() {
	byte _b;
...
void ADXL345::setFreeFallThreshold(short freeFallThreshold) {
...
short ADXL345::getFreeFallThreshold() {
	byte _b;
...
void ADXL345::setFreeFallDuration(short freeFallDuration) {
...
short ADXL345::getFreeFallDuration() {
	byte _b;
...
double ADXL345::getRate(){
	...
	_b &= B00001111;
	return (pow(2,((short) _b)-6)) * 6.25;
}

void ADXL345::setRate(double rate){
	byte _b,_s;
	short v = (short) (rate / 6.25);
	short r = 0;
	while (v >>= 1)
	{
		r++;
...
bool ADXL345::triggered(byte interrupts, short mask){
...
void ADXL345::setRegisterBit(byte regAdress, short bitPos, bool state) {
	byte _b;
...
bool ADXL345::getRegisterBit(byte regAdress, short bitPos) {
	byte _b;
	readFrom(regAdress, 1, &_b);
	return ((_b >> bitPos) & 1);
}
